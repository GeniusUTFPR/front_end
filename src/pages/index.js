...
export { EditarPerfil } from "./Usuario/Editar";
export { SerMonitor } from "./Usuario/Monitor";
...
export { CadastrarPaluno } from "./Professor/Paluno/Cadastrar";
export { ListarPaluno } from "./Professor/Paluno/Listar";
export { EditarPaluno } from "./Professor/Paluno/Editar";
